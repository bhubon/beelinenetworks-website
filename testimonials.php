...
<head>
  ...
  <meta charset="utf-8">
  <meta name="keywords"
    content="bootstrap 5, premium, multipurpose, sass, agency, seo, marketing, business, digital, rtl" />
  ...
  <div class="page-wrapper">
    ...
    <nav id="ht-main-nav">
      ...
      <a class="navbar-brand logo" href="/">
        <img class="img-fluid" src="./assets/images/Untitled-22.png" alt=""> </a>
      <p class="mt-3">Connecting local businesses in the cloud.</p>
      <div class="form-info">
        ...
        <div class="contact-link">
          <ul class="contact-info list-unstyled">
            <li>
              ...
              <span>Address:</span>
              <p>St James's House, Pendleton Wy., Pendleton, Salford M6 5FW, United Kingdom</p>
            </li>
            <li>
              <i class="flaticon flaticon-email"></i>
              <span>Email:</span>
              <a href="mailto:info@beelinenetworks.co.uk">info@beelinenetworks.co.uk</a>
            </li>
            <li>
              <i class="flaticon flaticon-mobile"></i>
              <span>Phone:</span>
              <a href="tel:03300880977">03300880977</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="container">
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
                ...
                if ($result->num_rows > 0):
                  while ($row = $result->fetch_assoc()):
                    ...
                    <div class="testimonial-item">
                      <h4><?php echo $row['title'] ? htmlspecialchars($row['title']) : ''; ?></h4>
                      <div class="review-date-icons">
                          ...
                          <div>
                            ...
                            if ($row['stars'] && $row['stars'] > 0) {
                              for ($i = 1; $i <= $row['stars']; $i++) {
                                ?>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#FFB900"
                                  viewBox="0 0 24 24">
                                  <path
                                    d="M12 .587l3.668 7.431 8.2 1.192-5.934 5.782 1.401 8.174L12 18.896l-7.335 3.87 1.401-8.174L.132 9.21l8.2-1.192z" />
                                </svg>
                                <?php
                              }
                            }
                        ...
                        <div class="review-date">
                          <?php echo $row['created_at'] ? htmlspecialchars(date("M d, Y", strtotime($row['created_at']))) : ''; ?>
                        </div>
                      </div>
                      <div class="review-description">
                        <p><?php echo $row['description'] ? htmlspecialchars($row['description']) : ''; ?></p>
                      </div>
                      <div class="reviewer-name">
                        <p><?php echo $row['name'] ? htmlspecialchars($row['name']) : ''; ?></p>
                      </div>
                    </div>
                    <?php
                  endwhile;
              ...
              <div class="testimonial-form mt-6">
                <div class="col-lg-12 col-md-12 mb-6 mb-lg-0 order-lg-1">
                  <form id="testimonial-form" method="post" action="php/testimonial.php">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input id="title" type="text" name="title" class="form-control"
                            placeholder="Summarize your review or highlight an interesting detail" required="required"
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea name="testimonial" id="testimonial" placeholder="Tell people your opinion" rows="5"
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input id="name" type="text" name="name" class="form-control" placeholder="Tell us your name"
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input id="email" type="text" name="email" class="form-control"
                            placeholder="Tell us your email" required="required" data-error="Email is required.">
                          <div class="help-block with-errors"></div>
                        </div>
                      </div>

                    </div>
                    <button type="submit" name="submit_btn" class="themeht-btn primary-btn mt-4">
    ...
    <footer class="footer">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-7 pe-lg-8">
              <a class="navbar-brand logo footer-logo" href="index.html">
                <img class="img-fluid" src="assets/images/Untitled-23.png" alt="">
              </a>
              <p class="mt-4 mb-5">Beeline Networks Ltd is Registered in England and Wales: Reg. No: 11127772.</p>
              <p class="mt-4 mb-5">Please note our contact number changed from 01915437116 to 03300880977 on 10/10/2024.
              </p>
            ...
            <div class="col-lg-4 col-md-5 mt-6 mt-md-0">
              ...
              <ul class="media-icon list-unstyled">
                <li>
                  ...
                  <p class="mb-0">St James's House, Pendleton Wy., Pendleton, Salford M6 5FW, United Kingdom</p>
                </li>
                <li>
                  <i class="flaticon-gps-1"></i>
                  <h6>Trading Address</h6>
                  <p class="mb-0">Office 4U, Safe Store Sunderland, Unit H, Hylton Riverside, Colima Avenue, Sunderland,
                    SR5 3XF</p>
                </li>
                <li>
      ...
      <div class="secondary-footer">
        <div class="container">
          <div class="copyright">
            <div class="row align-items-center">
              <div class="col-md-6">Copyright 2025 Beeline Networks Ltd | by <u>
                  <a href="https://www.wizwazeer.com/">WizWazeer</a>
                </u></div>
              <div class="col-md-6 text-md-end mt-3 mt-md-0">
                <ul class="list-inline ps-0 ms-0 footer-social">
                  <li class="list-inline-item">
                    <a href="https://heyjinni.com/">
